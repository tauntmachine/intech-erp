...
const TableMain = styled.div`
  ...
  width: ${(props) =>
    props.isFullScreen
      ? "99.5%"
      : props.smallWidth === "SetWidth"
      ? "40%"
      : "100.4%"};
  height: ${(props) =>
    props.isVisible ? "55vh" : "5px"}; /* Adjust height based on isVisible */
  margin-top: ${(props) =>
    props.isFullScreen ? "0" : props.marginTop ? "72px" : "0px"};
  margin-right: ${(props) => (props.isFullScreen ? "0" : "0px")};
  padding-top: ${(props) =>
    props.isFullScreen ? "10px" : props.marginTop ? "0" : "5px"};
...
const HeadlessTable = ({
  ...
  const table = useMantineReactTable({
    ...
    icons: {
      ...
      IconChevronDown: () => <LuChevronRight size={16} />,
      IconChevronsDown: () => <LuChevronDown size={16} />,
    },
    getRowProps: (row) => ({
      onDoubleClick: () => handleRowDoubleClick(row),
    }),
    ...
    mantineTableContainerProps: {
      sx: {
        ...
        minHeight: isFullScreen ? "77vh" : "50vh",
        margin: "0px 0px 0px 0px",
        // borderRadius: '8px',
          ...
          {CustomButtons ? null : (
            <Box>
              <CustomToolbarActions
                ...
                showCostCenterButton={CostCenterButton}
                showCostCenterButton1={CostCenterButton1}
                onCostCenterClick={EditClick}
                onCostListClick1={NewCostClick}
                onCostListClick2={deactiveClick}
                showCostCenterButton3={deactiveButton}
                showActiveButton={activeButton}
                onActiveClick={activeClick}
              />
            </Box>
          )}
