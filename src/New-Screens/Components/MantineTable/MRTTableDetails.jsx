...
const TableMain = styled.div`
  ...
  margin-top: ${(props) => (props.isFullScreen ? "0" : "2px")};
  margin-right: ${(props) => (props.isFullScreen ? "0" : "0px")};
  padding-top: ${(props) => (props.isFullScreen ? "10px" : "0px")};
...
const MRTTableDetails = ({
  ...
  const handleRowSelectionChange = (selectionState) => {
    setSelectedRowIds(new Set(selectionState.selectedRowIds));
  };
  ...
  const handleActionClick = (actionFunction) => {
    actionFunction();
    setIsMenuOpen(false); // This will close the menu after an action is clicked
  };
  ...
  <>
    <div style={{}}>
      <div
        ...
        onClick={() => handleActionClick(() => onAddRowAbove(row))}
      >
        Insert Row Above
      </div>
      <div
        ...
        onClick={() => handleActionClick(() => onAddRowBelow(row))}
      >
        Insert Row Below
      </div>
      <div
        ...
        onClick={() => handleActionClick(() => onDeleteRow(row.index))}
      >
        Delete Row
      </div>
      <div
        ...
        onClick={() => handleActionClick(() => onSBCRow(row))}
      >
        Scan Bar Code
      </div>
      <div
        ...
        onClick={() => handleActionClick(() => onALDRow(row))}
      >
    ...
    mantineTableBodyCellProps: (cell) => ({
      style: {
        ...
        color: "#464f60cc",
        // alignSelf: "center",
        textAlign: ["age", "credit", "debit"].includes(cell.column.id) ? "right" : "center",
    ...
    mantineTableContainerProps: {
      sx: {
        maxHeight: isFullScreen ? "91vh" : "63vh",
        minHeight: isFullScreen ? "91vh" : "63vh",
        margin: "0px 0px 0px 0px",
        // borderRadius: '8px',
    ...
    mantineTableBodyProps: {
      sx: {
        "& .mantine-TableBodyCell-Content:first-of-type": {
          justifyContent: "center",
          fontSize: "12px",
          color: "red",
          fontWeight: "700",
        ...
        >
          <Box>
            <CustomToolbarActions
              ...
              onTableDetailDeleteClick={onTableDetailDeleteClick}
...
export default MRTTableDetails;
