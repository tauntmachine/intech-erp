...
const HorizontalLine = styled.div`
  ...
  margin-top: ${(props) => (props.isVisible ? "3px" : "23px")};
  width: 100%;
`;
...
export default MRTLinkedTransaction;
