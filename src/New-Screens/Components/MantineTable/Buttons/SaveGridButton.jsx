...
const SaveGridButtonButton = ({ icon: Icon, color, hoverColor, title, size, height, fixWidth, onClick }) => {
  const sBlue = 'blue';
  const sGrey = 'grey';
  ...
  return (
    ...
    >
      <Image>
        {Icon && <Icon color={getIconColor()} size={18} />}
      </Image>
...
export default SaveGridButtonButton;
