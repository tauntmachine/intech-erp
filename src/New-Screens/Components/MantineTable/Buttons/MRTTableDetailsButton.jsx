...
const Btn = styled.div`
  padding: ${(props) => (props.height ? '7px 10px' : '9px 10px')};
  border-radius: 8px;
...
const MRTTableDetailsButton = ({ icon: Icon, color, hoverColor, title, size, height, fixWidth, onClick }) => {
  const sBlue = 'blue';
  const sGrey = 'grey';
...
export default MRTTableDetailsButton;
