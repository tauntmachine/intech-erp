...
// import { useMigration } from "react-redux";
...
const SalesOrderNew = ({ date }) => {
  ...
  const handleDateChange = (date) => {
    ...
    // Save or display the formatted date as needed
  };
      ...
      <Main>
        ...
        <Wrapit>
          <Header
            ...
            fourthNav={keys.KEY100140}
            navActive={"Sales Order - New"}
          />
          <HeaderNewButtons />
          <Div>
            {/* <AccountsSideNav
            ...
            <Hero>
              <TitleOfSection title={"SALES ORDER DETAILS"} />
              ...
              <Wrapper>
                ...
                <FieldsBox>
                  ...
                  <CalanderInput Name={"Delivery Date"} width={true} />
                </FieldsBox>
                {/* </Inputs> */}
              </Wrapper>
              <BottomRowInputs>
