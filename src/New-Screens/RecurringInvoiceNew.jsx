...
const RecurringInvoiceNew = (props) => {
    ...
    <>
      <Main>
        <NewScreensNav
          height={"30%"}
          // OPTIONS
          first={"Recurring Invoice Details"}
        ...
        <Wrapit>
         ...
         />  */}
            ...
            <Hero>
              <TitleOfSection title={"RECURRING INVOICE DETAILS"} />
...
export default RecurringInvoiceNew;
