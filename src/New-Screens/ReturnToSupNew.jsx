...
const ReturnToSupNew = () => {
  ...
  const [colDefs, setColDefs] = useState([
    ...
    {
      field: "poamount",
      headerName: "Supplier Analysis Code",
      // width: "150px",
      headerClass: "All-header",
      cellClass: "Center-Align",
    },
    {
      field: "poamount",
      headerName: "Supplier Analysis Code 1",
      // width: "150px",
      headerClass: "All-header",
      cellClass: "Center-Align",
    },
    {
      field: "poamount",
      headerName: "Supplier Analysis Code 2",
      // width: "150px",
      headerClass: "All-header",
      cellClass: "Center-Align",
    },
    {
      field: "poamount",
      headerName: "Supplier Analysis Code 3",
      // width: "150px",
      headerClass: "All-header",
      cellClass: "Center-Align",
    },
