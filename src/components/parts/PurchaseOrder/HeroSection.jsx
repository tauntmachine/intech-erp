          ...
          {HeaderData.map((item, index) => {
            return (
              <Head key={index}>
                ...
                <Text8>{item.purchase}</Text8>
                <Text9>{item.type}</Text9>
              ...
              {data.map((text, i) => {
                return (
                  <Wrapit key={i}>
                    ...
                    <Subtext6>{text.order}</Subtext6>
                    <Subtext15>{text.Date}</Subtext15>
