          ...
          {HeaderData.map((item, index) => {
            return (
              <Head key={index}>
                ...
                <Text10>{item.Frequency}</Text10>
                <Text12>{item.Reccure}</Text12>
              ...
              {data.map((text, i) => {
                return (
                  <Wrapit key={i}>
                    ...
                    <Subtext12>{text.Frequency}</Subtext12>
                    <Subtext14>{text.Reccure}</Subtext14>
                    <Subtext15>{text.interval}</Subtext15>
                    <Subtext13>{text.end}</Subtext13>
                    <Subtext16>{text.num}</Subtext16>
                    <Subtext17>{text.num}</Subtext17>
                  </Wrapit>
                );
              })}
            </CustomInfiniteScroll>
