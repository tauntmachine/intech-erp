...
const HeroSection = () => {
  const HeaderData = [
    {
      id: "ID",
      code: "Sales Agent Code",
      name: "Sales Agent Name",
      email: "Email",
      phone: "Phone Number",
      structure: "Comission Structure",
          ...
          {HeaderData.map((item, index) => {
            return (
              <Head key={index}>
                ...
                <Text5>{item.email}</Text5>
                <Text6>{item.phone}</Text6>
                <Text7>{item.structure}</Text7>
                <Text8>{item.type}</Text8>
                <Text9>{item.percent}</Text9>
                <Text10>{item.ammount}</Text10>
                <Text11>{item.base}</Text11>
                <Text12>{item.target}</Text12>
              </Head>
            );
          })}
          <WrapperList>
              ...
              {data.map((text, i) => {
                return (
                  <Wrapit key={i}>
                    ...
                    <Subtext5>{text.email}</Subtext5>
                    <Subtext6>{text.number}</Subtext6>
                    <Subtext7>{text.comission}</Subtext7>
                    <Subtext9>{text.type}</Subtext9>
                    <Subtext8>{text.percent}</Subtext8>
                    <Subtext10>{text.ammount}</Subtext10>
                    <Subtext11>{text.base}</Subtext11>
                    <Subtext12>{text.sales}</Subtext12>
                  </Wrapit>
                );
              })}
            </CustomInfiniteScroll>
