...
const P2PAdjustment = () => {
  ...
  const columns = useMemo(() => [
    ...
    {
      accessorKey: "p2pAdjustmentEntryNo",
      header: "P2P Adj Ent No",
    },
    {
  ...
  return (
    <Main>
      <TopDivWrapper>
        <TopDiv>
          <Header
            title={keys.KEY100357}
            firstNav={keys.KEY0002}
            secNav={keys.KEY1002}
            thirdNav={keys.KEY10011}
            navActive={keys.KEY10048}
          />
       <MRTTableListScreens
            columns={columns}
            data={data}
