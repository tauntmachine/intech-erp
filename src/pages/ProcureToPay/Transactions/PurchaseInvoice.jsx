import PurchaseInvoiceNew from "../../../New-Screens/PurchaseInvoiceNew";
  ...
  return screen === 1 ? (
    <Main>
      <TopDivWrapper>
        <TopDiv>
          <Header
            title={keys.KEY100181}
            firstNav={keys.KEY0002}
            thirdNav={keys.KEY10011}
            secNav={keys.KEY1003}
            navActive={keys.KEY100149}
          />
          <MRTTableListScreens
            columns={columns}
            data={data}
