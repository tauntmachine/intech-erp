import RecurringInvoiceNew from "../../../New-Screens/RecurringInvoiceNew";
...
const RecurringInvoice = () => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      accessorKey: 'recurringInvoiceno',
    },
    {
  ...
  return screen === 1 ? (
    <Main>
      <TopDivWrapper>
        <TopDiv>
          <Header
            title={keys.KEY100170}
            firstNav={keys.KEY0002}
            secNav={keys.KEY1002}
            thirdNav={keys.KEY10011}
            navActive={keys.KEY100355}
          />
          <MRTTableListScreens
            columns={columns}
            data={data}
